        ...
        do {
            ...
            for (let mApp of mApps) {
                try {
                    ...
                    this.log.warn(`Error on appointment update, retrying with patch...`, err.toString());
                    try {
                        let dCalType = Sync.mag2caltype(mApp); // Determined calendartype.
                        ...
                        this.log.error(`Retry failed aswell, skipping appointment! :(`, err.toString());
                    }
                }
            }
                ...
                for (let gAppId in gCal) {
                    ...
                    if (gAppId.includes('magbot') && gApp.status !== 'cancelled') {
                        try {
                            ...
                            this.log.error(`Failed deleting appointment!? Skipping... :(`, err.toString());
                        }
                    }
                }
            }
