	...
	if (authResult['code']) {
		...
		function getError(error) {
			...
			if (error == 'success: user updated') {
				return `<p>Je gegevens en voorkeuren zijn succesvol geupdate. Het kan even duren voordat alles is doorgevoerd en correct in je agenda komt.</p>`
			}
			...
			>>> > a99e641c37972b1bad2cc3a2c4b28aec925543f6
