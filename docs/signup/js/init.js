...
function success() {
  ...
  document.getElementById('error-modal-title').innerText = 'Succes'
  $('.modal-footer').hide()

  document.getElementById('error-modal-text').innerHTML = `
    <p>Je account is succesvol geactiveerd, en zal afhankelijk van het tijdstip, ongeveer elk half uur geupdate worden. Mocht je je voorkeuren willen veranderen, kan dat zo: ga naar magbot.nl -> activeren, en vul opnieuw je gegevens in met je nieuwe voorkeuren. Je agenda zal van dan af gevuld worden met afspraken zoals jij het wilt!</p>

    <p>Omdat het maken en levend houden van dit programma maandelijks geld kost, is er een mogelijkheid om een éénmalige donatie te doen, dat kan via PayPal of per bankoverschrijving. Een minimum van 7,49 is vereist om deze exclusieve <b style="display: block !important;">Voordelen van een donatie:</b>
      <span style="display: block !important;">• Supporten van Magbot, zodat iedereen er gebruik kan van blijven maken.</span>
      <span style="display: block !important;">• In plaats van de komende 2 weken in je agenda, de komende maand.</span>
      <span style="display: block !important;">• Speciale afspraken zoals toetsen en toetsweken in de komende 15 weken, komen alvast in je agenda te staan.</span>
    </p>
    ...
    <div style="float: right;">
      <p><b>Bankoverschrijving</b></p>
      <span>NL11 INGB 0001 3521 96</span>
    </div>
    <p></p>`
