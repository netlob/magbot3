...
function getError(error) {
  ...
  if(error == 'success: user updated') { return `<p>Je gegevens en voorkeuren zijn succesvol geüpdatet. Het kan even duren voordat alles is doorgevoerd en correct in je agenda komt.</p>` }
